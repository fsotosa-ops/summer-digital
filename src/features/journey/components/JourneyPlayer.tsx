      ...
      case 'kahoot':
        return (
          <div className="flex items-center justify-center h-full">
            <Card className="border-summer-lavender bg-summer-lavender/10 max-w-sm w-full mx-4">
            ...
            <DefaultPlaceholder
              ...
              icon={
                node.type === 'quiz' ? (
                  ...
                  <UsersIcon className="h-10 w-10 text-summer-yellow opacity-50" />
                ) : node.type === 'challenge' ? (
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-white flex flex-col">
      ...
      <div className="h-14 bg-white/95 backdrop-blur border-b border-slate-100 shadow-sm flex items-center px-4 gap-3 flex-shrink-0">
        ...
        {isPreviewMode && (
          <span className="bg-summer-yellow text-summer-yellow border border-summer-yellow text-[10px] font-bold
        ...
        {isPreviewMode && (
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-summer-lavender hover:text-summer-lavender
                       border border-summer-lavender hover:bg-summer-lavender/10 px-2 py-1 rounded-lg
            ...
            >
              ...
              <div className="text-center space-y-2 px-6">
                ...
                {xpEarned > 0 && !isPreviewMode && (
                  <p className="text-xl font-bold text-summer-yellow">
                    +{xpEarned} XP ganados
                  </p>
                )}
              </div>
