...
const RANK_COLORS: Record<string, string> = {
  ...
  Bosque: 'bg-fuchsia-100 text-fuchsia-700',
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-4">
              <Avatar className="h-16 w-16">
                ...
                <AvatarFallback className="bg-fuchsia-100 text-fuchsia-700 text-lg font-semibold">
                  {initials}
                </AvatarFallback>
              </Avatar>
              <div>
          ...
          <CardContent className="space-y-6">
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <p className="text-2xl font-bold text-fuchsia-600">{user.oasisScore}</p>
              </div>
